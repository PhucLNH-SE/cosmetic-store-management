...
public class ManageCategoryPageVM : BaseViewModel
{
    ...
    private void Delete(object? parameter)
    {
        ...
        ApplyFilter();
        statusmessage = "Delete category successfully. Category is now inactive.";
    }
    ...
    private string ValidateInput()
    {
        ...
        if (textboxitem.CategoryName.Trim().Length > 100)
        {
            return "Category name must be <= 100 characters.";
        }
